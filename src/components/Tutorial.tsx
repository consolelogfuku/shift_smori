...
const STEPS: { title: string; body: string }[] = [
  { title: 'データの扱いについて', body: 'データはサーバーには送られません。このタブを閉じると消えるので、作業中の場合は「保存する」を押して、途中経過を記録したファイルを手元に残すことができます。次に開くときは「読み込む」でそのファイルを選びます。' },
  ...
  { title: 'シフトを組んで保存する', body: '「シフトを組む」で実行し、結果を確認して Excel か CSV に出力します。終わったら「保存する」でファイルを手元に残してください。' },
];
