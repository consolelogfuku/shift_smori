...
const STEPS: { title: string; body: string }[] = [
  ...
  { title: 'シフトを組む', body: '「シフトを組む」で実行し、結果を確認して Excel か CSV に出力します。' },
  { title: 'データの扱いについて', body: 'データはこのタブを閉じると消えます。作業中の場合は「保存する」ボタンを押して、途中経過を記録したファイルを手元に残すことができます。作業を再開したい場合は、「読み込む」ボタンから途中経過ファイルを読み込ませてください。' },
];
